...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-900">
      <div className="w-full max-w-[393px] min-h-screen bg-[#131329] flex flex-col shadow-xl">
        ...
        <div className="px-6 pb-14 flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full h-14 border border-white/30 text-white rounded-xl text-base font-medium"
          >
            로그인
          </button>
        </div>
