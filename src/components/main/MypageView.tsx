...
export default function MypageView() {
  ...
  return (
    <div className="flex flex-col h-screen bg-bg">
      {/* 헤더 */}
      <div className="px-5 py-3 bg-bg-card flex items-center">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/flon_wordmark_v2_transparent.svg"
          alt="flon"
        ...
        <div className="bg-bg-card px-5 pt-6 pb-6 flex flex-col items-center border-b border-gray-100">
          ...
          {user && (
            <div className="flex gap-2">
              {user.jobType && (
                <span className="bg-bg-card text-primary-500 text-xs px-3 py-1 rounded-full border border-primary-300">
                  {user.jobType}
                </span>
              )}
              {user.freelancerYn && (
                <span className="bg-primary-50 text-primary-500 text-xs px-3 py-1 rounded-full border border-primary-100">
                  3.3% 적용
                </span>
              )}
            </div>
